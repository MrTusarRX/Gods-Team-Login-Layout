...
import com.kmrite.RootServices;
...
public class FloatingModMenuService extends Service {
	...
	private MSGConnection conn;
	private Messenger remoteMessenger; 
	private Messenger myMessenger = new Messenger(new Handler(Looper.getMainLooper(), null));
	public boolean serviceTestQueued;
	...
	public InterfaceInt INT(final int z1){
        return new InterfaceInt() {
            ...
            public void OnWrite(int i) {
                Changes(z1, i, FloatingModMenuService.this);
            }
        };
    }
    ...
    public InterfaceBool BOOL(final int z2){
        return new InterfaceBool() {
            ...
            public void OnWrite(boolean z) {
                Changes(z2, 0, FloatingModMenuService.this);
            }
        };
    }
    ...
    public InterfaceBtn BTN(final int i1){
        return new InterfaceBtn() {
            @Override
            public void OnWrite() {
                Changes(i1, 0, FloatingModMenuService.this);
            }
        };
    }
    ...
    public void addButton(String feature, final InterfaceBtn interfaceBtn) {
        ...
        button.setText(Html.fromHtml("<font color='#41c300'>" +feature + ": OFF"));
        button.setBackgroundColor(Color.parseColor("#7f0000"));
		final String feature2 = feature;
		if (this.remoteMessenger == null) {
            this.serviceTestQueued = true;
            Intent intent = new Intent(this, RootServices.class);
            MSGConnection mSGConnection = new MSGConnection();
            this.conn = mSGConnection;
            RootService.bind(intent, mSGConnection);
        }
		button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isActive) {
                        button.setText(Html.fromHtml("<font color='#41c300'>"+feature2+"</font>"));
	...
	public void addCheckBox(final String featureName, boolean z, final InterfaceBool interfaceBool) {
    ...
    public void addSwitch(String feature, final InterfaceBool sw) {
        ...
        switchR.setText(Html.fromHtml("<font face='roboto'>" + feature + "</font color='#41c300'>"));
	...
	public void Funçoes(String pkg, String lib, String offset, String hex) {
	...
	public void Funçoes(String pkg, String libname, int Offset, String hex) {
        Message message = Message.obtain(null, RootServices.MSG_GETINFO);
        message.getData().putString("pkg", pkg);
        message.getData().putString("fileSo", libname);
        message.getData().putInt("offset", Offset);
        message.getData().putString("hexNumber", hex);
        message.replyTo = myMessenger;
        try {
            remoteMessenger.send(message);
	...
	public final void setRemoteMessenger(Messenger messenger) {
